...
export default class Constructor {
  ...
  lightPos: vec3 = vec3.fromValues(0.5, 0.2, 1.0);
  ...
  async init(gl: WebGL2RenderingContext | null) {
    ...
    const emissionMap = await this.loadTexture("./images/matrix.jpg");
    // 设置顶点位置
    ...
    this.lightingShader.setInt("material.emission", 2);
    this.lightingShader.setFloat("matrixmove", currentFrame);
